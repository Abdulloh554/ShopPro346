    ...
    <div style={styles.container}>
      ...
      <aside style={{ ...styles.sidebar, width: sidebarOpen ? "260px" : "80px" }}>
        <div style={styles.logoContainer}>
          {sidebarOpen ? (
            <h1 style={styles.logoText}>SellerPanel</h1>
          ) : (
            <h1 style={styles.logoText}>S</h1>
          )}
        </div>
      ...
      <main style={styles.main}>
        <header style={styles.header}>
          ...
          <div style={styles.userInfo}>
            <div style={styles.badge}>Sotuvchi</div>
            <span style={styles.userName}>{user?.username || "Seller"}</span>
...
const NavItem = ({ icon, label, open, active, onClick }) => {
  ...
  const borderLeft = active ? "3px solid #10b981" : "3px solid transparent";
